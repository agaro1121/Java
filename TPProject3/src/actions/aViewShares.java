...
public class aViewShares implements iAction{
	...
	public String run(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			generalStatement = connection.prepareStatement(queries.getProperty("sharesHeld"));

			generalStatement.setInt(1, Integer.parseInt(session.getAttribute("UserID").toString()));
			generalStatement.setInt(2, Integer.parseInt(session.getAttribute("UserID").toString()));
			generalStatement.setInt(3, Integer.parseInt(session.getAttribute("UserID").toString()));
			generalStatement.setInt(4, Integer.parseInt(session.getAttribute("UserID").toString()));
		...
		return "WEB-INF/SHPages/ViewShares.jsp";
	}
