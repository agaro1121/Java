...
public class Deck {
    ...
    /**
     * Saves (serializes) the deck of cards to file
     * @param file
    ...
    /**
     * Loads(de-serializes) the deck of cards from file
     * @param file
     * @throws FileNotFoundException
     * @throws IOException
    ...
    public void Load(File file) throws FileNotFoundException, IOException, ClassNotFoundException {        
        ...
        String currentCardInStringFormat = br.readLine();
    }
